...
THREE.MeshLine.prototype.setPositions = function( g ) {

	var k = 0

	for( var j = 0; j < g.length; j += 3 ) {
		k = j*2
		this.positions[k] = this.positions[k+3] = g[ j ]
		this.positions[k+1] = this.positions[k+4] = g[ j+1 ]
		this.positions[k+2] = this.positions[k+5] = g[ j+2 ]
	}

	var l = this.positions.length / 6;

	// TODO reuse previous/next directly
	this.previous = [];
	this.next = [];
...
THREE.MeshLine.prototype.setWidth = function(widthCallback) {
